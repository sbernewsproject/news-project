...
Агрегатор новостей и банковских отзывов с RAG-ассистентом. Статьи парсятся из нескольких источников, хранятся в PostgreSQL, индексируются в Qdrant и доступны через REST API и веб-интерфейс. ИИ-ассистент отвечает на вопросы по базе с потоковой генерацией.
